        ...
        switch (direction)
        {
            case 0:
                if (y - 1 >= 0)
                {
                    ...
                    else if (relArray[y - 1, x] == 3 && holdObj == 2)
                    {
            ...
            case 1:
                if (x - 1 >= 0)
                {
                    ...
                    else if (relArray[y, x - 1] == 3 && holdObj == 2)
                    {
